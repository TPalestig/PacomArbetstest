...
namespace Samples
{
    ...
    public class Driver
    {
        ...
        private static async Task<int> Main(string[] args)
        {
            ...
            {
                await Task.Run(() => { });
                ModbusTcpMasterReadInputs();                                 // OK
                //ModbusTcpMasterReadInputs();                                 // OK
                //ModbusTcpMasterReadHoldingRegisters32();                     // OK, men crashar när man avslutar
                //ModbusUdpMasterWriteCoils();                                 // OK
                //ModbusSocketSerialMasterWriteRegisters();                    // Station #0 so no response allowed
                //ModbusSocketSerialMasterReadRegisters();                     // Function code 68 not supported.
                //ModbusSerialAsciiMasterReadRegisters();                      // Har inte någon serial ascii slave att prata med.
                //ModbusSerialRtuMasterWriteRegisters();                       // Har inte någon serial slave att prata med.
                //SimplePerfTest();                                            // Kod finns inte
                //StartModbusAsciiSlave();                                     // Kod finns inte
                //ModbusTcpMasterReadInputsFromModbusSlave();                  // Stannar bara, ingen respons
                //ModbusSerialAsciiMasterReadRegistersFromModbusSlave();       // Har inte någon serial ascii slave att prata med.
                //StartModbusTcpSlave();                                       // Stannar bara, ingen respons
                //StartModbusUdpSlave();                                       // Stannar bara, ingen respons
                //StartModbusAsciiSlave();                                     // Kod finns inte
                //await StartModbusSerialRtuSlaveNetwork(cts.Token);           // Har inte någon serial slave att prata med.
                //await StartModbusSerialRtuSlaveWithCustomMessage(cts.Token); // Har inte någon serial slave att prata med.
                //StartModbusSerialAsciiSlave();                               // Har inte någon serial ascii slave att prata med.
                //StartModbusSerialRtuSlave();                                 // Har inte någon serial slave att prata med.
                //await StartModbusSerialRtuSlaveWithCustomStore();            // Har inte någon serial slave att prata med.
                //ReadWrite32BitValue();                                       // Har inte någon serial slave att prata med.
            }
        ...
        /// </summary>
        public static void ModbusSocketSerialMasterWriteRegisters() // TCP!!!!
        {
        ...
        public static void ModbusUdpMasterWriteCoils()
        {
            ...
            using(TcpClient client = new TcpClient())
            {
                ...
                // write three coils
                master.WriteMultipleCoils(1, startAddress, new bool[] { true, false, true });
            }
        }
